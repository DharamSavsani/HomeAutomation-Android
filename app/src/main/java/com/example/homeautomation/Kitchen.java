...
public class Kitchen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Kitchen.this, ListActivity.class));
            }
        });
        ...
        living.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Kitchen.this, Living.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideRight(Kitchen.this);
            }
        });
        bed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Kitchen.this, Bed_rooms.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideRight(Kitchen.this);
            }
        });
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ed.apply();
                Intent i = new Intent(Kitchen.this, main_page.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideRight(Kitchen.this);
            }
        });
        ...
        myRef.child("Kitchen").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Kitchen.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        light1_stc.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (light1_stc.isChecked()) {
                    light_img.setImageResource(R.drawable.light_on);
                    send_data("Kitchen","L1", light1_stc.isChecked(), myRef);
                } else {
                    light_img.setImageResource(R.drawable.light);
                    send_data("Kitchen","L1", light1_stc.isChecked(), myRef);
                }
        ...
        fan1_stc.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (fan1_stc.isChecked()) {
                    fan_img.startAnimation(rotateAnimation);
                    send_data("Kitchen","F1", fan1_stc.isChecked(), myRef);
                } else {
                    fan_img.clearAnimation();
                    send_data("Kitchen","F1", fan1_stc.isChecked(), myRef);
                }
    ...
    void send_data(String field,String value, boolean b, DatabaseReference reference) {
        if (b) {
            ...
            Kitchen_data.put(value, "1");
            reference.child(field).updateChildren(Kitchen_data, new DatabaseReference.CompletionListener() {
                @Override
                public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                    if (error != null)
                        Toast.makeText(Kitchen.this, "Low connection", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            Map<String, Object> Kitchen_data = new HashMap<>();
            Kitchen_data.put(value, "0");
            reference.child(field).updateChildren(Kitchen_data, new DatabaseReference.CompletionListener() {
                @Override
                public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                    if (error != null)
