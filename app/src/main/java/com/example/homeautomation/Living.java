...
public class Living extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ed.putString("flag", "0");
                ed.apply();
                Intent i = new Intent(Living.this, MainActivity.class);
                startActivity(i);
            }
        });
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Living.this,ListActivity.class));
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ed.apply();
                Intent i = new Intent(Living.this, main_page.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideRight(Living.this);
            }
        });
        bed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Living.this, Bed_rooms.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideLeft(Living.this);
            }
        });
        kitchen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Living.this, Kitchen.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideLeft(Living.this);
            }
        });
        ...
        myRef.child("Living").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Living.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        light1_stc.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (light1_stc.isChecked()) {
                    light_img.setImageResource(R.drawable.light_on);
                    send_data("Living","L1", light1_stc.isChecked(), myRef);
                } else {
                    light_img.setImageResource(R.drawable.light);
                    send_data("Living","L1", light1_stc.isChecked(), myRef);
                }
        ...
        fan1_stc.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (fan1_stc.isChecked()) {
                    fan_img.startAnimation(rotateAnimation);
                    send_data("Living","F1", fan1_stc.isChecked(), myRef);
                } else {
                    fan_img.clearAnimation();
                    send_data("Living","F1", fan1_stc.isChecked(), myRef);
                }
    ...
    void send_data(String field,String value, boolean b, DatabaseReference reference) {
        if (b) {
            ...
            living_data.put(value, "1");
            reference.child(field).updateChildren(living_data, new DatabaseReference.CompletionListener() {
                @Override
                public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                    if (error != null)
                        Toast.makeText(Living.this, "Low connection", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            Map<String, Object> living_data = new HashMap<>();
            living_data.put(value, "0");
            reference.child(field).updateChildren(living_data, new DatabaseReference.CompletionListener() {
                @Override
                public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                    if (error != null)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SPEECH_INPUT && resultCode == RESULT_OK && data != null) {
            ...
            if (cmd.equals("light") || cmd.equals("start light") || cmd.equals("on the light") || cmd.equals("start the light")) {
                send_data("Living","L1", true, myRef);
            } else if (cmd.equals("fan") || cmd.equals("start fan") || cmd.equals("on the fan") || cmd.equals("start the fan")) {
                send_data("Living","F1", true, myRef);
            } else if (cmd.equals("light off") || cmd.equals("light of") || cmd.equals("off the light") || cmd.equals("of the light")) {
                send_data("Living","L1", false, myRef);
            } else if (cmd.equals("fan off") || cmd.equals("fan of") || cmd.equals("off the fan") || cmd.equals("of the fan")) {
